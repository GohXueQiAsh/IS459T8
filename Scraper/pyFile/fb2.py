...
df.to_json("fb2.json", orient='records')

with open('fb2.json', 'rb') as file:
    json_file = BytesIO(file.read())

s3 = boto3.resource('s3')
bucket_name = 'is459-g1t8-project'  # replace this with your S3 bucket name
object_key = 'read/fb2.json'  # the key under which the object will be stored in the S3 bucket
